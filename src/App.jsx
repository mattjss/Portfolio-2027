...
import ClockwiseCta from './components/ClockwiseCta';
...
//     previewUrl: "",
//     category: "Home / Selected Works",
//     className: "work-card-vid",
//     caseTabs: {
//       intro: [
//         { type: "text", label: "Project", content: "Design System 2.0" },
//         { type: "text", label: "Summary", content: "MakersPlace’s legacy design system wasn’t built to scale. It was rebuilt from scratch with a modular foundation anchored by a flexible card system, bringing faster design velocity, better consistency, and a premium experience aligned with the brand’s direction." },
//       ],
//       team: [
...
//       ],
//       overview: [
//         { type: "text", label: "Problem", content: "MakersPlace needed to strengthen its brand presence and align with a new business strategy. The legacy design system had hundreds of font styles and colors, duplicated components, and no sync between design and engineering libraries, making it impossible to maintain consistency or scale efficiently." },
//         { type: "text", label: "Goal", content: "The goal was to build a scalable design system that elevated the brand, improved design velocity, and brought consistency across all product surfaces." },
//         { type: "video", src: "/vids/o-1.mp4", caption: "Before" },
//         { type: "video", src: "/vids/o-2.mp4", caption: "After" },
//         { type: "text", label: "Solution", content: "I led the rebuild from scratch, working with product and engineering to streamline the system - cutting hundreds of font styles and colors down to a flexible foundation with clear standards both teams could rely on. I created and managed a component library that synced design and engineering for the first time." },
...
//         { type: "image", src: "/images/cs-overview-4.png", caption: "Icon Library" },
...
//         { type: "text", label: "Solution", content: "I led the redesign by first researching competitor PDPs and conducting user interviews with collectors to understand their purchase behavior. Testing wireframes and prototypes revealed a critical insight: collectors needed to view artwork and read details simultaneously without breaking focus." },
//         { type: "text", content: "I designed a fixed artwork viewer paired with a scrolling right rail, allowing users to inspect artwork at full quality while details remained accessible alongside. This eliminated the constant back-and-forth scrolling that plagued the legacy experience. I also updated the design system with new components built specifically for the PDP." },
//         { type: "image", src: "/images/cs-p-2-overview-2.png", caption: "Generative" },
//         { type: "image", src: "/images/cs-p-2-overview-3.png", caption: "Private Sales" },
//         { type: "text", label: "Results", content: "The redesigned PDP improved usability and engagement, meeting all industry-standard features. The improvements contributed to increase in GMS, including a 400% increase in 2024 from the Private Sales program, alongside measurable gains in session time and conversion rate." },
//       ],
//     },
//   },
//   {
...
//         { type: "text", label: "Summary", content: "The Exhibition Page was redesigned and integrated into the MakersPlace site, creating a more immersive, storytelling-focused experience while improving the purchase flow for higher conversion and GMS." },
//       ],
//       team: [
//         { type: "text", label: "Leadership", content: "Landon Langford, Andre Camara, Michael Skinner, Claus Enevoldsen" },
//         { type: "text", label: "Product Manager", content: "Aram Saloot" },
...
//       ],
//       overview: [
//         { type: "text", label: "Problem", content: "The original Exhibition Page was known as “Drops”, and was built in Webflow. It existed outside the MakersPlace site, creating a disjointed experience. It lacked a cohesive design, did not align with the new design system, and required multiple clicks to purchase, adding friction to the sales funnel." },
//         { type: "video", src: "/vids/cs-p-3-o-1.mp4", caption: "Before" },
//         { type: "text", label: "Goal", content: "Bring the exhibition experience in-house, align it with the new design system, and create a seamless path from discovery to purchase while giving artists a platform to tell their story." },   
//         { type: "video", src: "/vids/cs-p-3-o-2.mp4", caption: "After" },
//         { type: "text", label: "Solution", content: "I led cross-functional working sessions with product, marketing, business, and engineering to redesign the Exhibition Page within the MakersPlace platform using the updated design system and card framework." },
//         { type: "text", content: "The new experience prioritized storytelling by allowing artists to add 3–5 minute videos explaining their process, tools, and creative intent. A modular layout and a newly designed mini PDP (product detail page) embedded directly on the exhibition page enabled users to view artwork details and purchase without leaving the page, reducing friction in the sales funnel." },
//         { type: "text", label: "Results", content: "The Exhibition Page was redesigned and built within the MakersPlace platform using the new design system, with newly introduced provenance, auction mechanics, and a richer storytelling experience. The improved purchase flow led to increased sales conversions and higher GMS, while the storytelling elements enhanced artist-collector engagement. Session rate increased 1400%, average session length grew by 5 minutes, conversion rate rose 350%, and the page drove over $840,000 in GMS directly." },
//       ],
//     },
//   },
//   {
...
//         { type: "image", src: "/images/cs-p-4-overview-1.png", caption: "Generative" },
            ...
            <div className="row gx-4 gy-4">
              {WORK_ITEMS.map((item, i) => (
                <div className="col-sm-6 col-xl-4" key={i}>
                  <ProductCard item={item} items={WORK_ITEMS} index={i} />
                </div>
              ))}
            </div>
          </div>
